...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        StatusGUI.createButtons(this, 2);
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        StatusGUI.handleButtonClick(par1GuiButton, 2);
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        StatusGUI.drawStatusGUI(this, 2);
        drawString(fontRenderer, "ActionMC Mod v" + StatusGUI.version, 2, height - 20, 0xffffff);
